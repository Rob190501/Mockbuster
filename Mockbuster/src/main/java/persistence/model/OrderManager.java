...
public class OrderManager implements Serializable {
    ...
    public static final String RETRIEVE_BY_EMAIL_AND_PSW = "OrderManager.RETRIEVE_BY_EMAIL_AND_PSW";
    ...
    public OrderManager(Integer id, String email, String password) {
        this.id = id;
        this.email = email;
